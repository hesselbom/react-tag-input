...
var ReactTagInput = (function (_super) {
    ...
    function ReactTagInput() {
        ...
        _this.onInputChange = function (e) {
            _this.props.onInput(e.target.value);
        };
        _this.onInputKeyDown = function (e) {
            var _a;
            var _b = _this.props, input = _b.input, validator = _b.validator, removeOnBackspace = _b.removeOnBackspace, delimiters = _b.delimiters;
    ...
    ReactTagInput.prototype.render = function () {
        var _this = this;
        var _a = this.props, input = _a.input, tags = _a.tags, placeholder = _a.placeholder, maxTags = _a.maxTags, editable = _a.editable, readOnly = _a.readOnly, validator = _a.validator, removeOnBackspace = _a.removeOnBackspace;
